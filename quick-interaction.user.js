...
One of mods you are using is using an old version of SDK. It will work for now but please inform author to update`), window.bcModSdk);
    ...
    (function() {
      ...
      function updateSettingsPanel() {
        ...
        listEl.innerHTML = '<div class="xsact-settings"><label class="xsact-settings-row"><span>' + QiActT("settings.language") + '</span><select id="xsact-settings-lang">' + opts + '</select></label><label class="xsact-settings-row"><span>' + QiActT("settings.theme") + '</span><select id="xsact-settings-theme"><option value="dark"' + (state.theme === "dark" ? " selected" : "") + ">" + QiActT("ui.theme_dark") + '</option><option value="light"' + (state.theme === "light" ? " selected" : "") + ">" + QiActT("ui.theme_light") + '</option></select></label><label class="xsact-settings-row"><span>' + QiActT("settings.char_list_right") + '</span><span class="xsact-switch"><input type="checkbox" id="xsact-settings-char-right"' + (state.charPopoverRight ? " checked" : "") + '><span class="xsact-switch-track"></span></span></label><label class="xsact-settings-row"><span>' + QiActT("settings.chat_button") + '</span><span class="xsact-switch"><input type="checkbox" id="xsact-settings-chat"' + (state.chatButtonDocked ? " checked" : "") + '><span class="xsact-switch-track"></span></span></label><label class="xsact-settings-row"><span>' + QiActT("settings.enable_xiaosu") + '</span><span class="xsact-switch"><input type="checkbox" id="xsact-settings-xiaosu"' + (state.xiaosuPack ? " checked" : "") + '><span class="xsact-switch-track"></span></span></label></div>';
