    ...
    function createChatRoomToggleButton() {
        ...
        btn.id = 'xsact-chat-toggle-btn'; btn.type = 'button';
        ...
        state.chatToggleBtnEl = btn; updateToggleBtnStyle(); return btn;
    }
    function registerChatRoomToggle() {
        var L = window.Liko = window.Liko || {};
        var spec = {
            id: 'quick-interaction', order: 3, createButton: createChatRoomToggleButton, plain: true,
